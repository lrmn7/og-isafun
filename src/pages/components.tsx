      ...
      <main className="min-h-screen py-10">
        ...
        <ol className="mt-8 space-y-4">
          ...
          <li className="space-y-1">
            <h3>Arrow Link</h3>
            <div className="flex flex-wrap gap-2">
              <ArrowLink href="https://is-a.fun" direction="left">
                Direction Left
              </ArrowLink>
              <ArrowLink href="https://is-a.fun" direction="right">
                Direction Right
              </ArrowLink>
              <ArrowLink
                href="https://is-a.fun"
          ...
          <li className="space-y-1">
            ...
            <div className="flex flex-wrap gap-2">
              <ButtonLink href="https://is-a.fun" variant="primary">
                Primary Button
              </ButtonLink>
              <ButtonLink href="https://is-a.fun" variant="outline">
                Outline Button
              </ButtonLink>
              <ButtonLink href="https://is-a.fun" variant="ghost">
                Ghost Button
              </ButtonLink>
              <ButtonLink href="https://is-a.fun" variant="light">
                Light Button
              </ButtonLink>
              <ButtonLink href="https://is-a.fun" variant="dark">
                Dark Button
              </ButtonLink>
            </div>
          </li>
